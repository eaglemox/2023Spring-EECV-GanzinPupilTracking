...
parser.add_argument('--decay', type=float, default=3e-5, help='weight decay')

# file directory
parser.add_argument('--data_path', type=str, default='./dataset', help='relative path to dataset folder')
parser.add_argument('--model_save', type=str, default='./test7', help='folder to save best model\'s .pth file')
parser.add_argument('--log_save', type=str, default='./test7', help='folder to save csvlog file')
